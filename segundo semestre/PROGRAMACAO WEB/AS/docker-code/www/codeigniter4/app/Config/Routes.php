...
$routes->get('/detailsClient/(:num)', 'Client::detailsClient/$1');

$routes->get('/contact', 'Contact::index');
$routes->add('contact/sendContactAction', 'Contact::sendContact');
...
$routes->get('admin/detailsClient/(:num)', 'Admin\Client::detailsClient/$1');
$routes->get('admin/updateClient/(:num)', 'Admin\Client::updateClient/$1');
$routes->add('admin/updateClientAction/(:num)', 'Admin\Client::updateClientAction/$1');
$routes->get('admin/deleteClient/(:num)', 'Admin\Client::deleteClient/$1');
...
$routes->get('admin/listContacts', 'Admin\Contacts::listContacts');

$routes->add('admin/searchClientAction', 'Admin\Client::searchClientAction');

//Rota da API
$routes->get('/api/client', 'Api::clients');
